<template>
 ...
 <!-- Start -->
        <section class="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="portfolio">
            <div class="container">
                <div class="grid grid-cols-1 pb-8 text-center">
                    <h6 class="text-emerald-600 text-base font-medium uppercase mb-2">Portfolio</h6>
                ...
                <div v-for="item in portfolios" :key="item" class="relative rounded-md shadow-sm overflow-hidden group">
                    <img :src="item.image"
                    ...
                    <div class="content">
                        <div
                            ...
                            <a @click="showMultiple"
                                class="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white btn-icon rounded-full lightbox"><i
                                    :class="item.icon"></i></a>
                        </div>

                        <div
                            class="absolute z-10 opacity-0 group-hover:opacity-100 bottom-4 start-4 transition-all duration-500">
                            <NuxtLink to="/portfolio-detail"
                                class="h6 text-md font-medium text-white hover:text-emerald-600 transition duration-500">{{
                    item.name }}</NuxtLink>
        ...
        <!-- Start -->
        <section class="py-24 w-full table relative  bg-center bg-cover jarallax" data-jarallax data-speed="0.5"  :style="{ backgroundImage: `url(${backgroundImagePath})`, backgroundPosition: 'center', backgroundAttachment: 'fixed' }" >
            ...
            <div class="container relative">
                <div class="grid grid-cols-1 pb-8 text-center">
                    ...
                    <div class="relative mt-10">
                        <a href="#contact" class="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md">Get Started !</a>
                    </div>
                </div><!--end grid-->
            </div><!--end container-->
        </section><!--end section-->
...
<script>
import backgroundImagePath from '../../assets/images/bg/cta.png';
