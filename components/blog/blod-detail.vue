    ...
    <section class="relative md:py-24 py-16">
                ...
                <div class="lg:col-span-8 md:col-span-6">
                    <div class="p-6 rounded-md shadow dark:shadow-gray-800">
                        ...
                        <div class="mt-6">
                            ...
                            <p
                                class="text-slate-400 italic border-x-4 border-emerald-600 rounded-ss-xl rounded-ee-xl mt-3 p-3">
                            ...
                            <div class="grid lg:grid-cols-12 gap-6">
                                ...
                                <div class="lg:col-span-12">
                                    <button type="submit" id="submit" name="send"
                                        class="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md h-11 justify-center flex items-center">Send
                                        Message</button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="lg:col-span-4 md:col-span-6">
                    <div class="sticky top-20">
                        ...
                        <div class="text-center mt-8">
                            <img src="assets/images/client/04.jpg" class="size-24 mx-auto rounded-full shadow mb-4"
                                alt="">

                            <a href=""
                                class="text-lg font-medium hover:text-emerald-600 transition-all duration-500 ease-in-out h5">Cristina
                                Romsey</a>
                        ...
                        <ul class="list-none text-center mt-8">
                            <li class="inline"><a href=""
                                    class="size-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-emerald-600 hover:text-white hover:bg-emerald-600"><i
                                        class="uil uil-dribbble align-middle"></i></a></li>
                            <li class="inline"><a href=""
                                    class="size-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-emerald-600 hover:text-white hover:bg-emerald-600"><i
                                        class="uil uil-behance align-middle"></i></a></li>
                            <li class="inline"><a href=""
                                    class="size-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-emerald-600 hover:text-white hover:bg-emerald-600"><i
                                        class="uil uil-linkedin align-middle"></i></a></li>
                            <li class="inline"><a href=""
                                    class="size-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-emerald-600 hover:text-white hover:bg-emerald-600"><i
                                        class="uil uil-facebook-f align-middle"></i></a></li>
                            <li class="inline"><a href=""
                                    class="size-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-emerald-600 hover:text-white hover:bg-emerald-600"><i
                                        class="uil uil-instagram align-middle"></i></a></li>
                            <li class="inline"><a href=""
                                    class="size-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-emerald-600 hover:text-white hover:bg-emerald-600"><i
                                        class="uil uil-twitter align-middle"></i></a></li>
                        </ul><!--end icon-->
                    </div>
                </div>
            </div>
                ...
                <div v-for="item in blogs" :key="item"
                    ...
                    <div class="content p-6">
                        <NuxtLink to="/blog-detail"
                            class="text-lg hover:text-emerald-600 dark:text-white dark:hover:text-emerald-600 transition-all duration-500 ease-in-out font-medium">{{ item.title }}</NuxtLink>
                        <p class="text-slate-400 mt-3">{{ item.desc }}</p>

                        <div class="mt-5">
                            <NuxtLink to="/blog-detail"
                                class="btn btn-link hover:text-emerald-600 dark:hover:text-emerald-600 after:bg-emerald-600 dark:text-white transition duration-500">Read
        ...
        <div class="container lg:mt-24 mt-16">
            <div class="grid grid-cols-1 text-center">
                ...
                <div class="mt-6">
                    <a 
                        class="py-2 px-5 inline-block font-normal tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md"><i
    ...
    data() {
        return {
            blogs: [
                {
                    image: image,
                    title: 'Building Your Corporate Identity with ELSHARQUE',
