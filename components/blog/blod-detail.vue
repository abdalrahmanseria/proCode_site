    ...
    <section class="relative md:py-24 py-16">
                ...
                <div class="lg:col-span-8 md:col-span-6">
                    <div class="p-6 rounded-md shadow dark:shadow-gray-800">
                        ...
                        <div class="mt-6">
                            ...
                            <p
                                class="text-slate-400 italic border-x-4 border-blue-800 rounded-ss-xl rounded-ee-xl mt-3 p-3">
                            ...
                            <div class="grid lg:grid-cols-12 gap-6">
                                ...
                                <div class="lg:col-span-12">
                                    <button type="submit" id="submit" name="send"
                                        class="btn bg-blue-800 hover:bg-blue-900 border-blue-800 hover:border-blue-900 text-white rounded-md h-11 justify-center flex items-center">Send
                                        Message</button>
                                </div>
                            </div>
                        </form>
                ...
                <div class="lg:col-span-4 md:col-span-6">
                    <div class="sticky top-20">
                        ...
                        <div class="text-center mt-8">
                            ...
                            <a href=""
                                class="text-lg font-medium hover:text-blue-800 transition-all duration-500 ease-in-out h5">Cristina
                                Romsey</a>
                        ...
                        <ul class="list-none text-center mt-8">
                            <li class="inline"><a href=""
                                    class="size-8 inline-flex items-center text-center justify-center text-base font-normal tracking-wide align-middle transition duration-500 ease-in-out border border-gray-100 dark:border-gray-800 rounded-md text-slate-400 hover:border-blue-800 hover:text-white hover:bg-blue-800"><i
                ...
                <div v-for="item in blogs" :key="item"
                    ...
                    <div class="content p-6">
                        <NuxtLink to="/blog-detail"
                            class="text-lg hover:text-blue-800 dark:text-white dark:hover:text-blue-800 transition-all duration-500 ease-in-out font-medium">{{ item.title }}</NuxtLink>
                        <p class="text-slate-400 mt-3">{{ item.desc }}</p>

                        <div class="mt-5">
                            <NuxtLink to="/blog-detail"
                                class="btn btn-link hover:text-blue-800 dark:hover:text-blue-800 after:bg-blue-800 dark:text-white transition duration-500">Read
        ...
        <div class="container lg:mt-24 mt-16">
            <div class="grid grid-cols-1 text-center">
                ...
                <div class="mt-6">
                    <a 
                        class="py-2 px-5 inline-block font-normal tracking-wide border align-middle transition duration-500 ease-in-out text-base text-center bg-blue-800 hover:bg-blue-900 border-blue-800 hover:border-blue-900 text-white rounded-md"><i
