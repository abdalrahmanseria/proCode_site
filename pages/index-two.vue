<template>
    <navBar />
    <!-- Start Hero -->
    <section class="py-36 lg:py-72 lg:pb-0 md:pb-8 w-full table relative  bg-center bg-cover" id="home"
            ...
            <div class="grid lg:grid-cols-12 mt-10 md:grid-cols-2 gap-2">
                <div class="lg:col-span-7">
                    <h4
                        ...
                        Welcome to Elsharque <br> Excellence in Every Project</h4>

                    <p class="text-white opacity-50 mb-0 max-w-2xl text-lg">Partner with Elsharque for innovative solutions and exceptional service delivery that drives your business forward.</p>

                    <div class="relative mt-10">
                        <a href=""
                            class="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-full me-1">Get
                            Started</a>
                        <a  @click="toggle"  data-type="youtube" data-id="S_CGed6E610"
                            class="cursor-pointer btn btn-icon btn-lg bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-full lightbox"><i
                                class="mdi mdi-play text-xl align-middle"></i></a><small
                            class="text-white text-sm uppercase align-middle ms-2">Watch Now</small>
                    </div>
                </div>
                ...
                <div class="lg:col-span-5 mt-8 md:mt-0">
                    <div class="bg-white dark:bg-slate-900 rounded-xl shadow md:p-10 p-6 lg:ms-10 z-10 relative">
                        <h4 class="mb-5 font-medium text-2xl dark:text-white">We are offering 14 <br> days free trial
                        </h4>
                        ...
                        <form>
                            <div class="grid grid-cols-1">
                                ...
                                <a href="javascript:void (0)"
                                    class="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md w-full">Free
                                    Trial</a>
                            </div><!--end row-->
                        </form>
                        <!-- end form -->
...
import backgroundImagePath from '../../assets/images/bg/2.jpg';
