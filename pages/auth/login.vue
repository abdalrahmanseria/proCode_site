                                    ...
                                    <div class="grid grid-cols-1">
                                        ...
                                        <form class="ltr:text-left rtl:text-right">
                                            <div class="grid grid-cols-1">
                                                ...
                                                <div class="mb-4">
                                                    <a href="" class="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md w-full">Login / Sign in</a>
                                                </div>

                                                <div class="text-center">
                                                    <span class="text-slate-400 dark:text-slate-300 me-2">Don't have an account ?</span> <NuxtLink to="/auth/signup" class="text-dark dark:text-white fw-bold">Sign Up</NuxtLink>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
