                    ...
                    <div class="flex flex-col min-h-screen md:px-12 py-12 px-3">
                        ...
                        <div class="text-center mx-auto">
                            <NuxtLink to="/" class="flex items-center justify-center">
                                <img :src="logoImg" class="h-24" alt="ProCode Solutions">
                            </NuxtLink>
                        </div>
                        <!-- End Logo -->
                                    ...
                                    <form class="ltr:text-left rtl:text-right">
                                        <div class="grid grid-cols-1">
                                            <div class="mb-4">
                                                ...
                                                <input id="RegisterName" type="text" class="form-input mt-3"
                                                    placeholder="Harry">
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                <div class="flex items-center mb-0">
                                                    ...
                                                    <label class="form-checkbox-label text-slate-400" for="AcceptT&C">I
                                                        Accept <a href="" class="text-emerald-600">Terms And
                                                            Condition</a></label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                <a href=""
                                                    class="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md w-full">Register</a>
                                            </div>

                                            <div class="text-center">
                                                <span class="text-slate-400 dark:text-slate-300 me-2">Already have an
                                                    account ? </span>
                                                <NuxtLink to="/auth/login" class="text-dark dark:text-white fw-bold">Sign in
                                                </NuxtLink>
                                            </div>
                                        </div>
                                    </form>
                        ...
                        <!-- Start Footer -->
                        <div class="text-center">
                            <p class="text-gray-400">© {{ date }} ProCode Solutions. All rights reserved.</p>
                        </div>
                        <!-- End Footer -->
                    </div>
                </div><!--end col-->
