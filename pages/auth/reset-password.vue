                        ...
                        <div class="text-center my-auto">
                            <div
                                ...
                                <div class="grid grid-cols-1">
                                    ...
                                    <p class="text-slate-400 dark:text-slate-300 mb-6">Please enter your email address. You
                                    ...
                                    <form class="ltr:text-left rtl:text-right">
                                        <div class="grid grid-cols-1">
                                            ...
                                            <div class="mb-4">
                                                <a href=""
                                                    class="btn bg-emerald-600 hover:bg-emerald-700 border-emerald-600 hover:border-emerald-700 text-white rounded-md w-full">Send</a>
                                            </div>

                                            <div class="text-center">
                                                <span class="text-slate-400 dark:text-slate-300 me-2">Remember your password
                                                    ? </span>
                                                <NuxtLink to="/auth/login" class="text-dark fw-bold">Sign in</NuxtLink>
                                            </div>
                                        </div>
                                    </form>
                                </div>
